...
//encryptes the message using mod 27 addition
char* encryptMsg(char* buffer, char* key){
    ...
    for(i = 0; i < strlen(buffer); ++i){
        ...
        //now that we have values for the current char of buff and key, we can add them modulo 27
        int cypherVal;
  ...
  while(1){
    ...
    switch(spawnpid){
        ...
        case 0: {
            ...
            // //do the encryption
            char* encBuffer;
            encBuffer = encryptMsg(buffer, key);
